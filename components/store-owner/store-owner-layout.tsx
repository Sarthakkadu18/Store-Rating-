...
import { BarChart3, Star, Store, User, Settings, LogOut, Menu } from "lucide-react"
import Link from "next/link"
import { usePathname, useRouter } from "next/navigation"
import { cn } from "@/lib/utils"

const navigation = [
  { name: "Dashboard", href: "/store-dashboard", icon: BarChart3 },
  { name: "My Ratings", href: "/store-ratings", icon: Star },
  { name: "Store Info", href: "/store-info", icon: Store },
          ...
          <div className="flex items-center gap-4 px-6 py-4">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-semibold">
                {navigation.find((item) => item.href === pathname)?.name || "Store Dashboard"}
              </h2>
            </div>
          </div>
        </header>
